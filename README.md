## 📓Проєкт 1: Аналіз музичних платформ та поведінки користувачів | [view code](Analysis_of_Streaming_Platforms.ipynb) 
**Опис проєкту:**  
...
- `Analysis_of_Streaming_Platforms.ipynb` – основний ноутбук з аналізом.
